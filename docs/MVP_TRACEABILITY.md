...
| 18 | Data export and one-hour account deletion | Partial | `apps/mobile/src/features/account`, readable/encrypted exports, restore validation, deletion migration, and local finalizer drill | Connected scheduled finalizer plus encrypted restore on a separate clean device |
