...
| 19 | Accessibility checks for critical workflows | Partial | Semantic browser walkthrough, a direct fresh-origin production setup/sign-in landmark and H1/H2 hierarchy check, keyboard/focus checks, target-size audit, reduced motion, uncapped text scaling, and Lighthouse | VoiceOver/TalkBack and dynamic-type walkthroughs on physical devices |
