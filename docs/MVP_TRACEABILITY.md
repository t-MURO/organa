...
| 10 | Check-In mood, label, reflection, reminder, search, and trends | Partial | `apps/mobile/src/features/check-in`, keyed opaque same-day record IDs, durable save feedback, Check-In repositories/schedulers, and browser walkthrough | Physical reminder delivery and permission behavior |
